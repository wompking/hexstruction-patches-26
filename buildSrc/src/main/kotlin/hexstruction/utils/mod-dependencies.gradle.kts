...
abstract class HexstructionModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexstructionModDependenciesExtension>("hexstructionModDependencies")
