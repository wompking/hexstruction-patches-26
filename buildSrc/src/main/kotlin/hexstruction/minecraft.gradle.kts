...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexstruction.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexstruction-common-common-refmap.json
        // fixed:   hexstruction-common.refmap.json
